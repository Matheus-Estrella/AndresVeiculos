document.addEventListener('DOMContentLoaded', () => {
    ...
    entitySelector.addEventListener('change', function() {
        ...
        switch (entitySelector.value) {
            case 'Funcionario':
                endpoint = 'https://seu-endpoint.com/api/funcionarios';
                break;
            case 'ContasDoMes':
                endpoint = 'https://seu-endpoint.com/api/contasdomes';
                break;
            case 'Veiculos':
                endpoint = 'https://seu-endpoint.com/api/veiculos';
                break;
            case 'Servicos':
                endpoint = 'https://seu-endpoint.com/api/servicos';
                break;
        }
        fetchData(endpoint);
    });
